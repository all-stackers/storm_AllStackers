...
const HealthCard = ({ number, title, content }) => {
  ...
  return (
    <div className="p-5 w-[350px] flex flex-col justify-right bg-orange-100 rounded-[20px]">
      <div className="flex flex-row w-full">
        <span className="module_number text-4xl font-bold text-gray-900">
          {hindiNumber}
        </span>
        <span
          className={`w-full mt-[17px] ml-[10px] h-[5px] bg-yellow-300`}
        ></span>
      </div>
      {loading ? (
        <p>Loading...</p>
