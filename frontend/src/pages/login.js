                        ...
                        <div className="flex flex-col gap-y-[25px]">
                            <div className="flex flex-col justify-center items-center gap-y-[40px]">
                                ...
                                <div className="flex flex-col w-[70%]">
                                    ...
                                    <input type="tel" id="phone" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 box-border" placeholder="9137XXXXXX" pattern="[0-9]{10}" required
                                        value={mobileNumber}
                                        onChange={(event) => {
                                ...
                                <div className="flex flex-col w-[70%]">
                                    ...
                                    <input type="password" id="password" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 box-border" placeholder="•••••••••" required
                                        value={password}
                                        onChange={(event) => {
                        ...
                        ?
                            ...
                            >
                                ...
                                <div className="text-[14px]">
                                    ...
                                    <span className="text-purple-dark font-medium ml-[5px] cursor-pointer" onClick={() => {router.push("/signup")}}>Sign Up</span>
                                </div>
                            </div>
                        :
                            <div className="flex flex-col gap-y-[20px] mt-[65px] items-center">
